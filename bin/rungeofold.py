...
if len(sys.argv) < 2 or len(sys.argv) > 4:
  ...
  for value in omegaRange:
    ...
    permWrite.write('<tr><td>%s J/mol/&Aring;<sup>2</sup></td>'%(value))
  ...
  fitFile.close()
  permWrite.write('<h5>Projected half-life of unfolding in pure water (&Delta;G<sub>solvation</sub> = %s J/mol/&Aring;<sup>2</sup>): %s seconds</h5><br>'%(wat,hl))
