...
!***********************************************************************
        ...
        implicit none
        real,intent(in) ::  mat(3,3),v1(3)
        real,intent(out) :: v2(3)
        integer :: i
        do I=1,3
          v2(I)=mat(1,I)*v1(1)+mat(2,I)*v1(2)+mat(3,I)*v1(3)
        enddo
...
!* a X b = c, length of c  = d
        real(kind=kind_8),intent(in) :: a(3),b(3)
        real(kind=kind_8),intent(out) :: c(3),d
!* cross product A X B
        c(1)=a(2)*b(3)-a(3)*b(2)
        c(2)=a(3)*b(1)-a(1)*b(3)
        c(3)=a(1)*b(2)-a(2)*b(1)
...
!***********************************************************************
        ...
        implicit none
        real(kind=kind_8),intent(in) :: v1(3)
        real(kind=kind_8),intent(out) :: v2(3)
        real(kind=kind_8)             :: cc
...
!***********************************************************************
        real function mytanhd(dd)
        implicit none
        real(kind=kind_8) :: dd,y,ovrflo
        parameter(ovrflo=5.)
        if (dd > ovrflo) then
          y = 1.
