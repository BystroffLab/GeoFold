...
real,parameter :: DTHETA=3.0   !! five degree increments
...
jarg = iargc()
if (jarg < 4) then
  write(*,*) 'Usage: xmaskmask pbdfile binfile binary.log output.pdb'
...
do
  ...
  !! do i=1,MASKSIZE
    amask(1:MASKSIZE) = iand(masklib(1:MASKSIZE,itheta,imask),amask(1:MASKSIZE))
  !! enddo
